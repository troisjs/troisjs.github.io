<template>
  <Renderer resize :orbit-ctrl="{ enableDamping: true, dampingFactor: 0.05, autoRotate : true }" shadow>
    ...
    <Scene>
      ...
      <InstancedMesh @created="initIMesh" :count="NUM_INSTANCES" :cast-shadow="true" :receive-shadow="true">
